...
if grep -q -F "$imports" "$PROFILE_PATH"; then
  ...
  # If we're already exposing the dotfiles to home-manager, then the
  # fresh install should have already performed a switch for us. We
  # otherwise must switch here again to install all of our packages
  home-manager switch
fi
